...
// Fetch Case Details
$stmt = $pdo->prepare("SELECT cases.*, users.username as officer_name 
                      FROM cases 
...
// Fetch Notes
$notesStmt = $pdo->prepare("SELECT case_notes.*, users.username, users.role 
                           FROM case_notes 
...
// Fetch Evidence
$evStmt = $pdo->prepare("SELECT * FROM evidence WHERE case_id = ? ORDER BY created_at DESC");
$evStmt->execute([$case_id]);
$evidence = $evStmt->fetchAll();

// Fetch Suspects
$suspStmt = $pdo->prepare("SELECT criminals.*, case_suspects.involvement 
                          FROM criminals 
...
<body class="bg-gray-50 h-screen flex">
    ...
    <div class="flex-1 flex flex-col md:ml-64 transition-all duration-300">
        ...
        <main class="flex-1 overflow-y-auto p-6 md:p-8">
            ...
            <a href="cases.php" class="text-gray-500 hover:text-blue-600 mb-6 inline-block"><i
                    class="fas fa-arrow-left mr-1"></i> Back to Case Board</a>
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                    ...
                    <div class="mt-4 md:mt-0 flex gap-3">
                        <?php if ($_SESSION['role'] !== 'forensics'): ?>
                            <form action="../views/case_actions.php" method="POST">
                ...
                <div class="lg:col-span-2 space-y-8">
                                    ...
                                    <div class="border rounded p-3 hover:shadow-md transition bg-white relative group">
                                        <div
                                            ...
                                            <?php if (strpos($ev['file_type'], 'image') !== false): ?>
                                                <img src="../public/uploads/<?php echo htmlspecialchars($ev['file_path']); ?>"
                                        ...
                                        <a href="../public/uploads/<?php echo htmlspecialchars($ev['file_path']); ?>"
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <?php if ($_SESSION['role'] !== 'guest'): ?>
                            <form action="../views/case_actions.php" method="POST" class="relative">
                            ...
                            <div class="space-y-4">
                                <?php foreach ($suspects as $s): ?>
                                    <div
                                        ...
                                        <img src="../public/uploads/<?php echo $s['photo_path'] ? $s['photo_path'] : 'default.png'; ?>"
                                            class="w-10 h-10 rounded-full object-cover bg-gray-200">
                                        <div class="flex-1 min-w-0">
                                            <a href="view_criminal.php?id=<?php echo $s['id']; ?>"
