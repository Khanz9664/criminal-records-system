        ...
        <main class="flex-1 overflow-y-auto p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
                <div class="flex space-x-2 w-full md:w-auto">
                    <form action="<?php echo BASE_URL; ?>/criminals" method="GET"
                        class="flex w-full md:w-auto shadow-sm">
                        ...
                        <select name="status"
                            ...
                            <option value="In Custody" <?php echo $status == 'In Custody' ? 'selected' : ''; ?>>In
                                Custody</option>
                ...
                <?php if (in_array($_SESSION['role'], ['admin', 'officer'])): ?>
                    <a href="<?php echo BASE_URL; ?>/criminals/create"
                    ...
                    <div
                        ...
                        <div class="p-4">
                            ...
                            <a href="<?php echo BASE_URL; ?>/criminals/show?id=<?php echo $criminal['id']; ?>"
                                class="block w-full text-center bg-gray-50 hover:bg-gray-100 text-gray-700 font-medium py-2 rounded border border-gray-200 transition">
                                View Full Profile
                            </a>
                        </div>
                    </div>
