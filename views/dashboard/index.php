        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo number_format($totalCases); ?></h4>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo number_format($activeCases); ?></h4>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo number_format($totalCriminals); ?></h4>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 flex items-center">
                    ...
                    <div>
                        ...
                        <h4 class="text-2xl font-bold text-gray-800"><?php echo $clearanceRate; ?>%</h4>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex justify-between items-center">
                    ...
                    <a href="#" class="text-xs text-blue-600 hover:text-blue-800 font-medium">View All Logs</a>
                </div>
                <div class="p-0">
