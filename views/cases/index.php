        ...
        <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-50 p-6">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
                <div class="flex space-x-2 w-full md:w-auto">
                    <form action="<?php echo BASE_URL; ?>/cases" method="GET" class="flex w-full md:w-auto">
                ...
                <?php if (in_array($_SESSION['role'], ['admin', 'officer'])): ?>
                    <a href="<?php echo BASE_URL; ?>/cases/create"
                        ...
                        <?php foreach ($cases as $case): ?>
                            <tr class="hover:bg-gray-50 transition">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <a href="<?php echo BASE_URL; ?>/cases/show?id=<?php echo $case['id']; ?>"
